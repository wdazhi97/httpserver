...
/// The status of the response.
    ...
    namespace status_line {
        ...
        static boost::asio::const_buffer status_to_buffer(status_type status) {
            switch (status) {
                case status_type::ok:
                    return boost::asio::buffer(status_line_ok);
                case status_type::created:
                    return boost::asio::buffer(status_line_created);
                case status_type::accepted:
                    return boost::asio::buffer(status_line_accepted);
                case status_type::no_content:
                    return boost::asio::buffer(status_line_no_content);
                case status_type::multiple_choices:
                    return boost::asio::buffer(status_line_multiple_choices);
                case status_type::moved_permanently:
                    return boost::asio::buffer(status_line_moved_permanently);
                case status_type::moved_temporarily:
                    return boost::asio::buffer(status_line_moved_temporarily);
                case status_type::not_modified:
                    return boost::asio::buffer(status_line_not_modified);
                case status_type::bad_request:
                    return boost::asio::buffer(status_line_bad_request);
                case status_type::unauthorized:
                    return boost::asio::buffer(status_line_unauthorized);
                case status_type::forbidden:
                    return boost::asio::buffer(status_line_forbidden);
                case status_type::not_found:
                    return boost::asio::buffer(status_line_not_found);
                case status_type::internal_server_error:
                    return boost::asio::buffer(status_line_internal_server_error);
                case status_type::not_implemented:
                    return boost::asio::buffer(status_line_not_implemented);
                case status_type::bad_gateway:
                    return boost::asio::buffer(status_line_bad_gateway);
                case status_type::service_unavailable:
                    return boost::asio::buffer(status_line_service_unavailable);
                default:
                    return boost::asio::buffer(status_line_internal_server_error);
            }
        }
    ...
    struct response_content {
        static constexpr std::string_view response_ok =
                "<html>"
                "<head><title>Hello</title></head>"
                "<body><h1>Hello async_simple</h1></body>"
                "</html>";
        static constexpr std::string_view response_created =
                "<html>"
                "<head><title>Created</title></head>"
                "<body><h1>201 Created</h1></body>"
                "</html>";
        static constexpr std::string_view response_accepted =
                "<html>"
                "<head><title>Accepted</title></head>"
                "<body><h1>202 Accepted</h1></body>"
                "</html>";
        static constexpr std::string_view response_no_content =
                "<html>"
                "<head><title>No Content</title></head>"
                "<body><h1>204 Content</h1></body>"
                "</html>";
        static constexpr std::string_view response_multiple_choices =
                "<html>"
                "<head><title>Multiple Choices</title></head>"
                "<body><h1>300 Multiple Choices</h1></body>"
                "</html>";
        static constexpr std::string_view response_moved_permanently =
                "<html>"
                "<head><title>Moved Permanently</title></head>"
                "<body><h1>301 Moved Permanently</h1></body>"
                "</html>";
        static constexpr std::string_view response_moved_temporarily =
                "<html>"
                "<head><title>Moved Temporarily</title></head>"
                "<body><h1>302 Moved Temporarily</h1></body>"
                "</html>";
        static constexpr std::string_view response_not_modified =
                "<html>"
                "<head><title>Not Modified</title></head>"
                "<body><h1>304 Not Modified</h1></body>"
                "</html>";
        static constexpr std::string_view response_bad_request =
                "<html>"
                "<head><title>Bad Request</title></head>"
                "<body><h1>400 Bad Request</h1></body>"
                "</html>";
        static constexpr std::string_view response_unauthorized =
                "<html>"
                "<head><title>Unauthorized</title></head>"
                "<body><h1>401 Unauthorized</h1></body>"
                "</html>";
        static constexpr std::string_view response_forbidden =
                "<html>"
                "<head><title>Forbidden</title></head>"
                "<body><h1>403 Forbidden</h1></body>"
                "</html>";
        static constexpr std::string_view response_not_found =
                "<html>"
                "<head><title>Not Found</title></head>"
                "<body><h1>404 Not Found</h1></body>"
                "</html>";
        static constexpr std::string_view response_internal_server_error =
                "<html>"
                "<head><title>Internal Server Error</title></head>"
                "<body><h1>500 Internal Server Error</h1></body>"
                "</html>";
        static constexpr std::string_view response_not_implemented =
                "<html>"
                "<head><title>Not Implemented</title></head>"
                "<body><h1>501 Not Implemented</h1></body>"
                "</html>";
        static constexpr std::string_view response_bad_gateway =
                "<html>"
                "<head><title>Bad Gateway</title></head>"
                "<body><h1>502 Bad Gateway</h1></body>"
                "</html>";
        static constexpr std::string_view response_service_unavailable =
                "<html>"
                "<head><title>Service Unavailable</title></head>"
                "<body><h1>503 Service Unavailable</h1></body>"
                "</html>";

        static std::string_view to_string(status_type status) {
            switch (status) {
                case status_type::ok:
                    return response_ok;
                case status_type::created:
    ...
    static response build_response(status_type status) {
        response rep;
        rep.status = status;
